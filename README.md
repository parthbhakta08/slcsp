...
Go to the project directory with main.py file and run the following command:
python main.py

# NOTE
After running the script once, slcsp.csv file will be modified. Please revert the slcsp.csv file to its original state before running the script again.